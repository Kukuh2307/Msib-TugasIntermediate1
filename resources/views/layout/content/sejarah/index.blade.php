...
@section('content')
    ...
    <a href="sejarah/{{ $data->id }}" class="text-indigo-500 bg-indigo-100 py-5 ml-2 h-10 rounded-md hover:text-indigo-900 flex justify-center items-center w-32">Edit</a>
    @php
