...
@section('content')
    ...
    <a href="pariwisata/edit" class="text-indigo-500 bg-indigo-100 py-5 ml-8 h-10 rounded-md hover:text-indigo-900 flex justify-center items-center w-32">Edit</a>
